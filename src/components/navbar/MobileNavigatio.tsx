    ...
    <>
      ...
      <div className="fixed bottom-0 z-50 w-full -translate-x-1/2 bg-white border-t border-gray-200 left-1/2 dark:bg-white-700 dark:border-gray-600">
        ...
        <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
          ...
          <button onClick={accountHandleclick}
          ...
          >
            {/* <svg
              ...
              />
                      ...
                      <MdPersonOutline  className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" />
